          ...
          <div className="modal">
            ...
            <div className="form-group">
              ...
              <input className="form-input" placeholder="B09XXXXX"
                value={form.asin} onChange={function(e) { setForm({ asin: e.target.value, openPOQty: form.openPOQty, poReference: form.poReference, notes: form.notes }); }} />
            </div>
            <div className="form-group">
              <label className="form-label">Open PO Qty</label>
              <input className="form-input" type="number" min="0" placeholder="100"
                value={form.openPOQty} onChange={function(e) { setForm({ asin: form.asin, openPOQty: e.target.value, poReference: form.poReference, notes: form.notes }); }} />
            </div>
            <div className="form-group">
              <label className="form-label">PO Reference</label>
              <input className="form-input" placeholder="AMZ-PO-XXX"
                value={form.poReference} onChange={function(e) { setForm({ asin: form.asin, openPOQty: form.openPOQty, poReference: e.target.value, notes: form.notes }); }} />
            </div>
            <div className="form-group" style={{ marginBottom: 20 }}>
              <label className="form-label">Notes</label>
              <input className="form-input" placeholder="Optional"
                value={form.notes} onChange={function(e) { setForm({ asin: form.asin, openPOQty: form.openPOQty, poReference: form.poReference, notes: e.target.value }); }} />
            </div>
